...
CameraBase::CameraBase()
	: m_pos(0.0f, 3.0f, -3.0f), m_look(0.0f, 0.0f, 0.0f), m_up(0.0f, 1.0f, 0.0f)
	, m_fovy(DirectX::XMConvertToRadians(60.0f)), m_aspect(16.0f / 9.0f), m_near(0.3f), m_far(100.0f)
{
...
DirectX::XMFLOAT4X4 CameraBase::GetProjectionMatrix()
{
	...
	proj = DirectX::XMMatrixPerspectiveFovLH(m_fovy,
